...
export const FOSSILS: Record<FossilId, Fossil> = {
  ...
  blattodea: {
    ...
    description: "Baratas (Blattodea) são extremamente comuns na Formação Crato. Esses insetos oportunistas habitavam a serapilheira e decompunham matéria orgânica às margens dos lagos. Sua morfologia cretácea é quase idêntica à das baratas modernas.",
